...
namespace HL.DAL
{
    public abstract class DbHelperSQL207
    {
        //数据库连接字符串(web.config来配置)，可以动态更改connectionString支持多数据库.  
        private static string connectionString = ConfigurationManager.ConnectionStrings["SqlConnection207"].ConnectionString;
        public DbHelperSQL207()
        {            
        }
        #region 公用方法
        /// <summary>
